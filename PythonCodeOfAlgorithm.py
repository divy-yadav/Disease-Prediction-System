...
# Explicitly call infer_objects to retain the old behavior
...
def plotScatterMatrix(df1, plotSize, textSize):
    ...
    df1 = df1.dropna(axis='columns')  # Specify axis parameter to drop columns with NaN values
    columnNames = list(df1)
...
# Make sure df is defined before calling the functions
...
root.title('MediMinds Disease Predictor System')
root.resizable(0,0)
...
w2 = Label(root, justify=LEFT, text="Disease Predictor AI ML", fg="white", bg="#4d4d4d")
w2.config(font=("Poppins",30,"bold"))
w2.grid(row=1, column=0, columnspan=2, padx=100)


#Label for the name
NameLb = Label(root, text="Name of the Patient", fg="white", bg="#4d4d4d")
NameLb.config(font=("Poppins",15,"bold"))
NameLb.grid(row=6, column=0, pady=15, sticky=W)

#Creating Labels for the symtoms
S1Lb = Label(root, text="Symptom 1", fg="#111111", bg="#4d4d4d")
S1Lb.config(font=("Poppins",15,"bold "))
S1Lb.grid(row=7, column=0, pady=10, sticky=W)

S2Lb = Label(root, text="Symptom 2", fg="#111111", bg="#4d4d4d")
S2Lb.config(font=("Poppins",15,"bold "))
S2Lb.grid(row=8, column=0, pady=10, sticky=W)

S3Lb = Label(root, text="Symptom 3", fg="#111111",bg="#4d4d4d")
S3Lb.config(font=("Poppins",15,"bold "))
S3Lb.grid(row=9, column=0, pady=10, sticky=W)

S4Lb = Label(root, text="Symptom 4", fg="#111111", bg="#4d4d4d")
S4Lb.config(font=("Poppins",15,"bold "))
S4Lb.grid(row=10, column=0, pady=10, sticky=W)

S5Lb = Label(root, text="Symptom 5", fg="#111111", bg="#4d4d4d")
S5Lb.config(font=("Poppins",15,"bold "))
S5Lb.grid(row=11, column=0, pady=10, sticky=W)

#Labels for the different algorithms
lrLb = Label(root, text="DecisionTree", fg="#F2613F", bg="#4d4d4d", width = 20)
lrLb.config(font=("Poppins",15,"bold "))
lrLb.grid(row=15, column=0, pady=10,sticky=W)

destreeLb = Label(root, text="RandomForest", fg="#F2613F", bg="#4d4d4d", width = 20)
destreeLb.config(font=("Poppins",15,"bold "))
destreeLb.grid(row=17, column=0, pady=10, sticky=W)

ranfLb = Label(root, text="NaiveBayes", fg="#F2613F", bg="#4d4d4d", width = 20)
ranfLb.config(font=("Poppins",15,"bold "))
ranfLb.grid(row=19, column=0, pady=10, sticky=W)

knnLb = Label(root, text="kNearestNeighbour", fg="#F2613F", bg="#4d4d4d", width = 20)
knnLb.config(font=("Poppins",15,"bold "))
...
dst = Button(root, text="Prediction 1", command=DecisionTree,bg="#4d4d4d",fg="#9B3922")
dst.config(font=("Poppins",15,"bold "))
dst.grid(row=6, column=3,padx=10)

rnf = Button(root, text="Prediction 2", command=randomforest,bg="#4d4d4d",fg="#9B3922")
rnf.config(font=("Poppins",15,"bold "))
rnf.grid(row=7, column=3,padx=10)

lr = Button(root, text="Prediction 3", command=NaiveBayes,bg="#4d4d4d",fg="#9B3922")
lr.config(font=("Poppins",15,"bold "))
lr.grid(row=8, column=3,padx=10)

kn = Button(root, text="Prediction 4", command=KNN,bg="#4d4d4d",fg="#9B3922")
kn.config(font=("Poppins",15,"bold "))
kn.grid(row=9, column=3,padx=10)

rs = Button(root,text="Reset Inputs", command=Reset,bg="#0C0C0C",fg="#EEEEEE",width=15)
rs.config(font=("Poppins",15,"bold "))
rs.grid(row=10,column=3,padx=10)

ex = Button(root,text="Exit System", command=Exit,bg="#0C0C0C",fg="#EEEEEE",width=15)
ex.config(font=("Poppins",15,"bold "))
ex.grid(row=11,column=3,padx=10)

#Showing the output of different algorithms
t1=Label(root,font=("Poppins",15,"bold "),text="Decision Tree",height=1,bg="#4d4d4d"
         ,width=40,fg="white",textvariable=pred1,relief="sunken").grid(row=15, column=1, padx=10)

t2=Label(root,font=("Poppins",15,"bold "),text="Random Forest",height=1,bg="#4d4d4d"
         ,width=40,fg="white",textvariable=pred2,relief="sunken").grid(row=17, column=1, padx=10)

t3=Label(root,font=("Poppins",15,"bold "),text="Naive Bayes",height=1,bg="#4d4d4d"
         ,width=40,fg="white",textvariable=pred3,relief="sunken").grid(row=19, column=1, padx=10)

t4=Label(root,font=("Poppins",15,"bold "),text="kNearest Neighbour",height=1,bg="#4d4d4d"
